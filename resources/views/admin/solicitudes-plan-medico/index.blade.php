    ...
    <div class="row">
        ...
        <div class="col-md-4">
            <div class="box box-info">
                ...
                <div class="box-body">
                    <a href="{{ route('crear_solicitud_pm') }}" class="btn btn-primary">Crear solicitud</a>
                    <a href="{{ route('exportar_solicitudes_pm') }}" class="btn btn-success">Exportar todo</a>
                    <form method="post" enctype="multipart/form-data" action="{{ route('importar_solicitudes_pm') }}">
                        {{ csrf_field() }}
                ...
                <tbody>
                    @forelse($solicitudes as $solicitud)
                        <tr{!! !$solicitud->vista ? ' class="sinver"' : '' !!}>
                            ...
                            <td class="text-right">
                                <a href="{{ route('editar_solicitud_pm', compact('solicitud')) }}" role="button" class="btn btn-warning btn-circle"><i class="glyphicon glyphicon-edit"></i></a>
                                <a href="{{ route('eliminar_solicitud_pm', compact('solicitud')) }}" role="button" class="btn btn-danger btn-circle axys-confirmar-eliminar"><i class="glyphicon glyphicon-remove"></i></a>
                            </td>
                        </tr>
                    @empty
                        <tr>
