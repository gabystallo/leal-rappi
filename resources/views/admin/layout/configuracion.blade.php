        ...
        <ul class="control-sidebar-menu">
            <li>
                <a href="{{ route('administradores') }}">
                    ...
                    <div class="menu-info">
                        <h4 class="control-sidebar-subheading">Cuentas de administrador</h4>
                        <p>Crear cuentas para este panel</p>
                    </div>
                </a>
            </li>
            <?php /*
            <li>
                <a href="{{ url('configuraciones') }}">
                    ...
                    <div class="menu-info">
                        <h4 class="control-sidebar-subheading">Configuraciones</h4>
