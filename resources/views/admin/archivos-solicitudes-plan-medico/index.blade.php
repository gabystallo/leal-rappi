...
@section('content')
    ...
    <div class="row">
        ...
        <div class="col-md-4">
            <div class="box box-info">
                ...
                <div class="box-body">
                    <a href="{{ route('crear_archivo_solicitud_pm', $solicitud) }}" class="btn btn-primary">Crear archivo</a>
                </div>
            </div>
        </div>
    ...
    <div class="box">
                ...
                <tbody>
                    @forelse($archivos as $archivo)
                        <tr>
                            ...
                            <td class="text-right">
                                <a href="{{ route('editar_archivo_solicitud_pm', compact('solicitud', 'archivo')) }}" role="button" class="btn btn-warning btn-circle"><i class="glyphicon glyphicon-edit"></i></a>
                                <a href="{{ route('eliminar_archivo_solicitud_pm', compact('solicitud', 'archivo')) }}" role="button" class="btn btn-danger btn-circle axys-confirmar-eliminar"><i class="glyphicon glyphicon-remove"></i></a>
                            </td>
        ...
        <div class="box-footer">
            <a href="{{ route('editar_solicitud_pm', $solicitud) }}" class="btn btn-info">Volver</a>
        </div>
    </div>
@endsection
        ...
        $(function(){
            $("#tabla-ordenable tbody").sortable({
                update:function(){
                    ...
                    $.ajax({
                        url:'{{ route("ordenar_archivos_solicitud_pm", $solicitud) }}',
                        method:'post',
                        data:{'ids':array},
