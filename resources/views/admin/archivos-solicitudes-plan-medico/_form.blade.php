...
<div class="col-md-6 form-group{{ has_error($errors,'archivo') }}">
    ...
    @if($archivo->tiene('archivo'))
        <p>
            <a href="{{ route('eliminar_archivo_archivo_solicitud_pm', ['solicitud' => $solicitud->id, 'archivo' => $archivo->id]) }}" class="btn btn-sm btn-danger" title="Eliminar"><span class="glyphicon glyphicon-remove"></span> Eliminar</a>
